...
export default class Exam extends Component {
  ...
  feildCheck = async () => {
    ...
    switch (switchType) {
      ...
      case 'branch':
        ...
        await this.formApi && this.formApi.setValues(data);
        await this.onSubmit();
        break;
      default:
        data['client'] = client || code;
  ...
  adduserNavigation() {
    ...
    if (form === "offlineExam" && form !== 'section' && form !== 'viewQuestions')
      return <NavLink className="btn btn-primary btn-sm" to={`${subDirectory}/exam/add/exam`}>+ Add Exam</NavLink>
    if (form === 'section')
        ...
        {!isPageLoading && !isLoading &&
          <Fragment>
            <Breadcrumb>
              ...
              {/* //* {(form === "section" || form === "viewQuestions") && <BreadcrumbItem><NavLink to={`${subDirectory}/exam/offlineExam`} title="Exam Id">Exam</NavLink></BreadcrumbItem>} */}
              {(form === "section" || form === "viewQuestions") && <BreadcrumbItem>Exam</BreadcrumbItem>}
              ...
              <Container fluid>
                ...
                <div className="d-md-flex align-items-md-center justify-content-md-between maincontentheader">
                  ...
                  <div className="d-flex justify-content-end">
                    ...
                    {form === "onlineExam" &&
                      < NavLink className="btn btn-primary btn-sm" to={`${subDirectory}/result`}>View Result</NavLink>}
                  </div>
                </div>
