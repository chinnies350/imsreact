...
export default class ExamForm extends Component {
  ...
  schema = {
    ...
    outoff: Joi.number().min(0).required().label("Total Marks"),
  }
  ...
  clientDatas = async (name) => {
    ...
    switch (name) {
      ...
      case "branch":
        ...
        // http://192.168.1.22:7000/ims-api/scheduleTypeId?client=987&entity=678&branch=1&type=exam&queryType=offline
        ...
        <Fragment>
          <Container fluid>
            <Breadcrumb>
              ...
              <BreadcrumbItem><NavLink to={`${subDirectory}/exam/offlineExam`}>Exam </NavLink>
              </BreadcrumbItem>
                ...
                <div className="page-user">
                  ...
                  {isBatch && <section>
                    <Row>
                      {isClient && <Col sm={12} md={3}>
                           {/* Client as Group */}
                        <CustomSelect field="client" label="Group*" title="clientName" name="client" getOptionValue={option => option.code}
                      ...
                      {isEntity && <Col sm={12} md={3}>
                        ...
                        <CustomSelect field="entity" label="Institution*" title="entityName" name="entity" getOptionValue={option => option.code}
                  ...
                  <section>
                    <Row>
                      ...
                      <Col sm={12} md={3}>
                        {/* <label>Date*</label> */}
                        <CustomDatePicker isOutsideRange={isOutsideRange} field="date" label="Date*" id="date" date={date} validate={e => this.validateProperty('date', e)} onChange={this.dateValue} onBlur={(e) => this.validateProperty('date', e)} numberOfMonths={1} disabled={selectdisabled}/>
                      </Col>
                      <Col sm={12} md={3}>
