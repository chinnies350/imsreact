...
export default class ClassForm extends Component {
  state = {
    data: {
      ...
      timeTable: [], noofperiods: 1, staff: "", noofdays: 6
    },
    days: [{ name: 'Monday' }, { name: 'Tuesday' }, { name: 'Wednesday' }, { name: 'Thursday' }, { name: 'Friday' }, { name: 'Saturday' }],
  ...
  schema = {
    ...
    noofdays: Joi.number().min(1).required().label("No of Days"),

    noofperiods: Joi.number().min(1).required().label("No of Periods"),
  ...
  onSubmit = async () => {
    ...
    if (actiontype === 'add') {
      ...
      console.log(res,classtimetableData)
  ...
  resetForm = () => { //Clear the form values afer the submission            
    ...
    let path = `${subDirectory}/timetable/Class` 
                ...
                <div className="page-user">
                  ...
                  <section>
                    <Row>
                      <Col sm={12} md={3}>
                        <Input
                          field="noofdays" label="No of Days *" name="noofdays"
                          validateOnBlur validate={e => this.validateProperty('noofdays', e)} 
                        />
                      </Col>
                      <Col sm={12} md={3}>
