...
export default class Assignment extends Component {
  ...
  addAssignmentNavigation(type) { //Navigate to Add module Page
    return <NavLink className="btn btn-primary btn-sm btn-right" to={`${subDirectory}/assignments/add/${type}`}>+ Add {type}</NavLink>
  }
  ...
  render() {
    ...
    if (_form === "Assignment") _form = "Assignment Marks"
    if (_form === "Homework") _form = "Homework Marks"
        ...
        {!isPageLoading && !isLoading &&
          <Fragment>
            ...
            <Container fluid>
              ...
              {type === 'homework' && !isTableLoading && hwstsdata && rightsData &&
                this.renderAssignmentForm(type, hwstsdata, this.state.data.client, this.state.data.entity, this.state.data.branch, this.state.department, this.state.batch, this.state.homeworks, this.state.homeworkId)
              }
              ...
              {/* {type === 'assignment' && !isTableLoading && assigndata && rightsData &&
               ...
               {type === 'assignment' && !isTableLoading && assigndata && rightsData &&
                this.renderAssignmentForm(type, assigndata, this.state.data.client, this.state.data.entity, this.state.data.branch, this.state.department, this.state.batch, this.state.assignments, this.state.assignmentId)
              }
            </Container>
          </Fragment>
        }
