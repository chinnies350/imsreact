              ...
              <div>
                <section>
                  ...
                  {formState.values.educationDetails &&
                    formState.values.educationDetails.map((educationDetails, i) => (
                      <Scope scope={`educationDetails[${i}]`} key={i}>
                        <Row>
                          ...
                          <Col sm={12} md={4}>
                            <MP field="from" label="From*" name="from" year={parseInt(fromYear)} month={parseInt(fromMonth - 1)}></MP>
                          </Col>
                          <Col sm={12} md={4}>
                            <MP field="to" label="To*" name="to" year={parseInt(toYear)} month={parseInt(toMonth - 1)}></MP>
                          </Col>
                          <Col sm={12} md={12}>
