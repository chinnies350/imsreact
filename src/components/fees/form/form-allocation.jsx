...
export default class FeeallocationForm extends Component {
  ...
  schema = {
    ...
    fineAmount: Joi.number().min(0).required().label('Fine Amount'),
  ...
  resetForm = () => {
    this.formApi.reset()
    let path = `${subDirectory}/fees/feeallocation`  
              ...
              <p>{formState.values.endDate}</p> */}
                ...
                <Row>
                  {isClient && <Col sm={12} md={3}>
                       {/* Client as Group */}
                    <CustomSelect field="client" label="GRopu*" name="client" getOptionValue={option => option.code} validateOnBlur validate={e => this.validateProperty('client', e)} getOptionLabel={option => option.name} options={clientIds}
                ...
                <Row>
                  ...
                  <Col sm={12} md={3}>
                    <Input
                      ...
                      validateOnBlur    validate={e => this.validateProperty('amount', e)}
                    />
                  </Col>
                  ...
                  <Col sm={12} md={3}>
                    <Input
                      ...
                      validateOnBlur   validate={e => this.validateProperty('fineAmount', e)}
                    />
                  </Col>
                  <Col sm={12} md={3}>
                  ...
                  <Col sm={12} md={5}>
                    <label>Date*</label>
                    <DRP1 field="date" label="Date*" id="date"
                     startDate={moment(formState.values.startDate)}
                      endDate={moment(formState.values.endDate)} 
                      onChange={(data) => this.dateValue(data, "date")}
                      validateOnBlur
