...
export default class Attendance extends Component {
  ...
  async componentDidMount() {
    console.log("attendens",this.props)
  ...
  attendanceList = async () => {
    console.log(" attendanceeeeeeeeeeeeeeee")
    ...
    console.log(attendancestatus,params)
              ...
              <div className="d-md-flex align-items-md-center justify-content-md-between maincontentheader">
                ...
                <div>
                  {rightsData && rightsData[_form] && rightsData[_form].create.value &&
                    <NavLink className="btn btn-primary btn-sm" to={`${subDirectory}/attendance/add/${attendanceType}`}>+ {attendanceType} </NavLink>
                  }
                </div>
              </div>
