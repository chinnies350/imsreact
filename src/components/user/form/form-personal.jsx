...
export default class PersonalForm extends Component {
    ...
    schema = {
        ...
        .label("Aadhar")
        .error(() => {
          return { message: "Enter Valid Aadhar Id" };
        })
        .required(),
    ...
    onSubmit = async () => {
        ...
        if (res.data.statusCode === 1) {
            ...
            props.history.push(`${subDirectory}/${client}/${entity}/${branch}/${uid}/edit/communication`)
        }
        ...
        return (
            <Fragment>
                <Form getApi={this.setFormApi} onSubmit={this.onSubmit} >
                    {({ formApi, formState }) => (
                        <div>
                            {console.log(";;;;;;;;;;;;;;; the formstate at personal ", formState)}
                            <section>
                                ...
                                <Row>
                                    ...
                                    <Col sm={12} md={4}>
                                        ...
                                        <CustomDatePicker field="dob" isOutsideRange={isOutsideRange} id="dob" date={dob} validate={e => this.validateProperty('dob', e)} onChange={this.dateValue} onBlur={(e) => this.validateProperty('dob', e)} numberOfMonths={1}/>
                                    </Col>
                                    <Col sm={6} md={4}>
                                ...
                                <Row>
                                    ...
                                    <Col sm={12} md={3}>
                                        <Input
                                            ...
                                            onChange={(e) => this.handleChange("profileImage", e)}
                                        />
                                    </Col>
                                </Row>
                            </section>
                            <div className="text-right">
                             { console.log(formState)   ,       
                              !Object.values(_.omit(formState.values,['middleName','profileImage','profileImageUrl'])).some(value=>{return value==""||value==null||value=="undefined"})&&
