...
export default class ExtracurricularForm extends Component {
  ...
  onSubmit = async () => {
    ...
    if (res.data.statusCode === 1) {
      ...
      // props.history.push(`${subDirectory}/users`)
      // props.history.push(`${subDirectory}/staffs`);
      props.history.push(`${subDirectory}/dashboard`);

      // window.location.reload();
    } else if (res.data.statusCode === 0) ToastService.Toast(res.data.message, "default");
    else ToastService.Toast(`Failed to update Extra curricular Details`, "default");
  };
              ...
              <div className="text-right">
                {
                  ...
                  !Object.values(formState.values).some((value) => {
