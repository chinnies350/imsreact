...
export default class RegisterForm extends Component {
    ...
    async componentDidMount() {
        const { location: { state: { addType } } } = this.props.props;
        const { data } = this.state;
        if (addType === "staff") data.userType = "staff";
        if (addType === "student") data.userType = "student";
    ...
    onSubmit = async () => {
        ...
        if (res.data.statusCode === 1) {
            ...
            props.history.push(`${subDirectory}/${data.client}/${data.entity}/${data.branch}/${data.uid}/edit/personal`)
                ...
                <Form getApi={this.setFormApi} onSubmit={this.onSubmit}>
                  ...
                  {/* Client as Group  and Entity as Institution*/}
                                ...
                                <Row>
                                    <Col sm={6} md={4}>
                                        <CustomSelect field="userType" label="UserType*" name="userType" getOptionValue={option => option.id}
                                            ...
                                            validateOnBlur validate={e => this.validateProperty('userType', e)} onChange={this.handleChange} disabled />
                                    </Col>
                                    <Col sm={6} md={4}>
                                        <Input
                            ...
                            <div className="text-right">
                                ...
                                console.log( 
                                      !Object.values(formState.values).some(value=>{return value==""||value==null||value=="undefined"})
                             )
...
//  console.log(formState)   ,       
    !Object.values(_.omit(formState.values,['parentPassword','parentUid'])).some(value=>{return value==""||value==null||value=="undefined"})&&
