...
export default class ParentForm extends Component {
    ...
    shortParentSchema = {
        ...
        .error(() => {
          return { message: "Enter Correct Contact Number" };
        })
        .required(),
    }
    ...
    schema = {
        ...
        income:Joi.number().min(1 ).required(),
    ...
    onSubmit = async () => {
        ...
        if (res.data.statusCode === 1) {
            ...
            props.history.push(`${subDirectory}/${data.client}/${data.entity}/${data.branch}/${data.uid}/edit/other`)
        }
                    ...
                    <Form getApi={this.setFormApi} onSubmit={this.onSubmit}>
                        {({ formApi, formState }) => (
                            <div>
                                ...
                                {formState.values.parentDetails &&
                    formState.values.parentDetails.every((parent) => {
                      return (
