...
export default class UserRoot extends Component {
  ...
  checkLoggedIn = async () => {
    ...
    const { userType, userLevel, client, entity, branch, department, batch, uid, branchId, code } = sessionData;
    ...
    await this.getUser((Data) => {
      Data = Data.filter(d => d.userType === 'student');  
