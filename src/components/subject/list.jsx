...
export default class SubjectList extends Component {
    ...
    getColumnHeaders(prefixUrl = "") { //dynamic headers 
        ...
        let def = {
            ...
            "Description": { dataField: 'author[0].desc', text: 'Description', sort: true },
    ...
    actionsFormatter = (cell, row, rowIndex, formatExtraData) => {
        ...
        rightsData && rightsData[_form] && rightsData[_form].edit.value &&
            links.push(<div onClick={() => this.editFun(`${subDirectory}/course/subject/edit`, row)} className='badge badge-warning'>Edit</div>)
