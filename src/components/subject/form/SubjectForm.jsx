...
export default class Subjects extends Component {
    ...
    async componentDidMount() {
        ...
        this.selectoptGet(`clients`, "clientIds")//Get the Client Lists
            ...
            if(this.props.actionTypes=="add"&&this.props.props.session.data){
            const{client,code,entity,branchId,userType}=this.props.props.session.data
            data.client=client;
            data.entity=code;
    ...
    resetForm = () => { //Clear the form values afer the submission 
        this.formApi.reset()
        let path = `${subDirectory}/course/subject-list` //Redirect the page after updated the datas
    ...
    render() {
        ...
        console.log(this.state,this.props,"subjects")
        return (
            <Fragment>
