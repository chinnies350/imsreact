...
console.log("staff list")
  ...
  getColumnHeaders(type, prefixUrl = "", dynamicLabels = {}) {
    ...
    let allKeys = ["Title", "From", "To", "staffId", "status", "period", "name", "actions"]
    let excludeKeys = []
    ...
    let def = {
      ...
      "staffId": { dataField: 'studentId', text: 'StaffId ', sort: true, filter: this.getTextFilter() },
  ...
  actionsFormatter = (cell, row, rowIndex, formatExtraData) => {
    ...
    rightsData && rightsData[_form] && rightsData[_form].edit.value && attendanceType === 'holiday' &&
      links.push(<div style={{ cursor: 'pointer' }} onClick={() => this.editFun(`${subDirectory}/attendance/edit`, row)} className='badge badge-warning'>Edit</div>)
