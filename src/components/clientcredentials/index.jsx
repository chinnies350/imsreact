...
export default class CredentialsRoot extends Component {
    ...
    addNavigation(form) {
        if (form === 'mail') {
            return <NavLink className="btn btn-primary btn-sm" to={`${subDirectory}/credentials/mail/add`}>+ Add {form} </NavLink>
        } else {
            return <NavLink className="btn btn-primary btn-sm" to={`${subDirectory}/credentials/sms/add`}>+ Add {form} </NavLink>
        }
    }
                ...
                {!isPageLoading && !isLoading &&
                    <Fragment>
                        <Breadcrumb>
                            ...
                            <BreadcrumbItem><NavLink to={`${subDirectory}/credentials/mailform`}>credentials</NavLink></BreadcrumbItem>
                        ...
                        <Container fluid>
                            ...
                            <div className="d-md-flex align-items-md-center justify-content-md-between maincontentheader">
                                <h5 class="pg-title">Credentials - {form}</h5>
                                <div>
                                    {
