...
export default class AddClientSettings extends Component {
  ...
  resetForm = () => {
    ...
    if (action === 'edit') {
      this.props.props.history.push(`${subDirectory}/settings/${formType}`)
    }
  }
  ...
  render() {
    ...
    const { clientIds, entityIds, branchIds, departmentIds,
      ...
      console.log(formType === 'batch' && isDepartment)
    return (
      <Fragment>
        ...
        <Form getApi={this.setFormApi} onSubmit={this.onSubmit} >
          {({ formApi, formState }) => (
            <div>
              {
                (formType === 'department' || formType === 'batch' || formType === 'boardtype' || formType === 'religion' || formType === 'religion' || formType === 'modules') && isBatch ?
