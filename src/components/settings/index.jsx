...
export default class SettingsRoot extends Component {
    ...
    rightsData = async (session) => {
        ...
        var moduleName = "groupmasters";
        if( formType === 'department' || formType === 'batch'  || formType === 'boardtype') moduleName= "institutionmasters"
    ...
    getAllDetails = async () => {
        ...
        await this.getLanguageDetails();
        await this.casteDetails();
        await this.subcasteDetails();
        await this.getStateDetails();
        await this.titleDetails();
        await this.getReligionDetails();
    }
    ...
    adduserNavigation(formType) { //Navigate to Add module Page
        return <NavLink className="btn btn-primary btn-sm btn-right" to={`${subDirectory}/settings/add/${formType}`}>+ Add {formType}</NavLink>
    }
    ...
    render() {
        ...
        if(_form === "Subcaste") _form = "SubCaste"
        if(_form === "Boardtype") _form = "BoardType"
        return (
            <div className="">
                ...
                {!isPageLoading && !isLoading &&
                    <Fragment>
                        <Breadcrumb>
                            ...
                            <BreadcrumbItem><NavLink to={`${subDirectory}/settings/department`}>settings</NavLink></BreadcrumbItem>
