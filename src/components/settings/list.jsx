...
export default class SettingsList extends Component {
    ...
    actionsFormatter = (cell, row, rowIndex, formatExtraData) => {
        ...
        rightsData && rightsData[_form] && rightsData[_form].edit.value &&
            links.push(<div onClick={() => this.editFun(`${subDirectory}/settings/edit/${formType}`, row)} className='badge badge-warning'>Edit</div>)
    ...
    adduserNavigation() {
        const { formType } = this.props
        return <NavLink className="btn btn-primary btn-sm" to={`${subDirectory}/settings/add/${formType}`}>+ Add {formType}</NavLink>
    }
