...
export default class Roles extends Component {
  ...
  onSubmit = async () => {
    ...
    if (roleDetails.data.statusCode === 1) 
      await this.setState({isTable:true,roles: roleDetails.data.data});
    else
      await this.setState({isTable:true,roles: []});
  };
  ...
  renderRolesForm(data) {
    ...
    return <RolesList data={data} props={this.props} rightsData={rightsData} refreshTable={()=>this.onSubmit()}/>;
  }
        ...
        {!isPageLoading && !isLoading && (
          <Fragment>
            ...
            <Container fluid>
              ...
              {isTable && roles && rightsData && this.renderRolesForm(roles)}
            </Container>
          </Fragment>
        )}
      </div>
