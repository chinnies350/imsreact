...
export default class RolesList extends Component {
    ...
    actionsFormatter = (cell, row, rowIndex, formatExtraData) => {
        ...
        rightsData && rightsData[_form] && rightsData[_form].edit.value &&
            links.push(<div onClick={() => this.editFun(`${subDirectory}/roles/edit`, row)} className='badge badge-warning'>Edit</div>)
        ...
        rightsData && rightsData[_form] && rightsData[_form].assign.value &&
            links.push(<div onClick={() => this.assignRoles(`${subDirectory}/roles/assign`, row)} className='badge badge-danger'>Assign</div>)
