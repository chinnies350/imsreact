...
export default class Scholastics extends Component {
  ...
  schema = {
    ...
    weightage: Joi.number().min(1).required().label("Weightage"),
      ...
      <Fragment>
        <Container fluid>
          <Breadcrumb>
            ...
            <BreadcrumbItem><NavLink to={`${subDirectory}/grade/assessmentWeightage`}>Assessment Weightage</NavLink></BreadcrumbItem>
            <BreadcrumbItem active>{actionType} Assessment Weightage</BreadcrumbItem>
          </Breadcrumb>
          <div className="mb-4">
            ...
            {({ formApi, formState }) => (
              <div>
                ...
                <section>
                  <Row>
                    <Col sm={6} md={3}>
                      <CustomSelect field="type" label="Type *" 
                      getOptionValue={option => option.code} 
                      getOptionLabel={option => option.name} 
                      validateOnBlur validate={e => this.validateProperty('type', e)} 
                      // onChange={this.handleChange}   
                      options={types} disabled={formActionType} />
                    </Col>

                    <Col sm={6} md={3}>
                      <Input field="mode" label="Assessment Name *"
                       validateOnBlur validate={e => this.validateProperty('mode', e)} 
                       readOnly={formActionType} />
                    </Col>
                    <Col sm={6} md={3}>
                      <Input field="weightage" label="Weightage *"
                       validateOnBlur 
                      //  validate={e => this.validateProperty('weightage', e)} 
                      validate={(e) => validateProperty(true, "numberRange", e, "Weightage",{min:0,max:1000})}
