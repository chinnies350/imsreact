    ...
    return (
      <Fragment>
        <div className="d-md-flex align-items-md-center justify-content-md-between maincontentheader">
          <h5 class="pg-title">SubjectWise Report</h5>
          <div>
            ...
            <section>
              <Row>
                {isClient && <Col sm={6} md={3}>
                  ...
                  <CustomSelect field="client" label="Grorup*" name="client" getOptionValue={option => option.code} getOptionLabel={option => option.name} validateOnBlur validate={e => this.validateProperty('client', e)} onChange={this.handleChange} options={clientIds} />
                </Col>}
