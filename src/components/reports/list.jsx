...
export default class ReportList extends Component {
    ...
    async getColumnHeaders(type, prefixUrl = "") {
        let allKeys = ["UserID", "Name", "Subject", "Topic", "Marks", "TotalMarks", "PaidAmount", "PaidDate", "Amount", "FineAmount", "Remarks", "Status", "sMark", "sReMark","createdDate"];
        let excludeKeys = [];
        if (type === "attendance") {
        ...
        let def = {
            ...
            "createdDate":{ dataField: 'createdDate', text: 'Created Date', sort: true},
        ...
        switch (type) {
            ...
            case "attendance":
                ...
                excludeKeys = ["Subject", "Topic", "sMark", "Marks", "TotalMarks", "PaidAmount", "PaidDate", "Amount", "FineAmount", "sReMark", "Remarks", "Status","createdDate"]
                break;
            case "assignment":
                excludeKeys = ["Status", "PaidAmount", "PaidDate", "Amount", "FineAmount", "sReMark", "Remarks", "sMark"]
                break;
            case "homework":
                excludeKeys = ["Marks", "TotalMarks", "PaidAmount", "PaidDate", "Amount", "FineAmount", "sReMark", "Remarks", "sMark","createdDate"]
                break;
            case "fees":
                excludeKeys = ["Subject", "Topic", "Marks", "TotalMarks", "sReMark", "Remarks","createdDate"]
                break;
            case "staff":
                excludeKeys = ["Subject", "Topic", "Marks", "TotalMarks", "PaidAmount", "PaidDate", "Amount", "FineAmount", "Remarks", "Status","createdDate"]
                break;
            default:
                excludeKeys = ["createdDate"]
                break;
        }
    ...
    render() {
        ...
        if(_form === "Attendance") _form = "Attendance Reports"
        console.log(_form,rightsData)
        const options = {
            paginationSize: 4,
            pageStartIndex: 1,
            sizePerPage: 100,
        ...
        return (
            <React.Fragment >
                <div className="d-md-flex align-items-md-center justify-content-md-between">
                    ...
                    <div>
                        {
                            rightsData && rightsData[_form] && rightsData[_form].view && rightsData[_form].view.value && type !== 'attendance' && type !== 'staff' && 
