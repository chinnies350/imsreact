...
export default class CourseAttendeesForm extends Component {
    ...
    resetForm = () => {
        ...
        this.formApi.reset()
        let path = `${subDirectory}/course/externalcourse-list` //Redirect the page after updated the datas
    ...
    onSubmit = async () => { //Store Datas to the APIs
        console.log('edit external course ')    
        const { actionTypes } = this.props;
        let response;
        ...
        if (actionTypes === 'add') {
            ...
            console.log(response,addparams)
        }
                                ...
                                <Row>
                                    ...
                                    <Col sm={12} md={3}>
                                        <Input
                                            ...
                                            validateOnBlur
                                            //  validate={e => this.validateProperty('fee', e)}
                      validate={(e) => validateProperty(true, "numberRange", e, "Weightage",{min:0,max:10000000})}

                                        />
                                    </Col>
                                    <Col sm={12} md={3} style={{ marginTop: '-1px' }}>
                                        {
                                            studentList &&
                                            <div>
