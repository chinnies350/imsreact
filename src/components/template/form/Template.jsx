...
export default class Template extends Component {
    ...
    formStateCheck = async (data) => {
        console.log('dfvbgsdhsdsdsdsdsdsdsdsdsdsdh')
        let r, url;
    ...
    clientDatas = async (name, value) => { // Get the Client,Entity,Branch,Department,Batch,EventName Lists
        ...
        switch (name) {
            ...
            case "type":
                ...
                console.log(value,actionType,name)
                await this.getCredentials();
                break;
    ...
    resetForm = (Type) => { //Reset the values after Submission
        ...
        this.formApi.reset()
        if (actionType === 'edit') {
            let path = `${subDirectory}/templatesList/${Type}` //Redirect the page after updated the datas
    ...
    onSubmit = async () => {
        ...
        if (type === 'mail') {
            data =
                ...
                console.log(data)
            if (actionType === 'add') {
                console.log('hfffffffffffffffffffffffffg')
                ...
                if (config && config !== '')
                
                 {
                    ...
                    //* this.props.props.history.push(`/notification/template`);
                     this.props.props.history.push(`${subDirectory}/notification/template`);
                }
            }
            if (actionType === 'edit') {
                url = `https://api.sendgrid.com/v3/templates/${id}`
