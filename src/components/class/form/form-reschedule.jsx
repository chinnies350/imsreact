...
export default class Reschedule extends Component {
    ...
    async componentDidMount() {
      console.log("rescheduling",this.props)
      console.log("data",this.props)
      const { data } = this.state
      console.log(this.props.props.session.data)
      if(this.props.props.session.data.length!=0){
          console.log(this.props.props.session.data)
    ...
    resetForm = () => {
        this.formApi.reset()
        let path = `${subDirectory}/classLists/rescheduletable` //Redirect the page after updated the datas
                                        ...
                                        <Row>
                                            <Col sm={12} md={3}>
                                                ...
                                                <CustomSelect field="client" label="Group*" name="client" getOptionValue={option => option.code}
                                                    ...
                                                    validateOnBlur validate={e => this.validateProperty('client', e)} onChange={this.handleChange} disabled={true}/>
                                            </Col>
                                            <Col sm={12} md={3}>
                                                ...
                                                <CustomSelect field="entity" label="Institution*" name="entity" getOptionValue={option => option.code}
                                                    ...
                                                    validateOnBlur validate={e => this.validateProperty('entity', e)} onChange={this.handleChange} disabled={true}/>
                                            </Col>
                                            <Col sm={12} md={3}>
                                                <CustomSelect field="branch" label="Branch*" name="branch" getOptionValue={option => option.code}
                                                    ...
                                                    validateOnBlur validate={e => this.validateProperty('branch', e)} onChange={this.handleChange} disabled={true}/>
                                            </Col>
                                            <Col sm={12} md={3}>
