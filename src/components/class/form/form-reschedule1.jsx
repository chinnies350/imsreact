                                ...
                                <div className="page-user">
                                    ...
                                    <section>
                                        <Row>
                                            <Col sm={6} md={3}>
                                                <label>Date *</label>
                                                <CustomDatePicker field="SelectedDate" isOutsideRange={isOutsideRange} id="SelectedDate" date={SelectedDate} onChange={this.dateValue}
                                                    onBlur={(e) => this.validateProperty('SelectedDate', e)} numberOfMonths={1}/>
                                            </Col>
                                            <Col sm={6} md={3}>
