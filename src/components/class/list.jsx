  ...
  render() {
    ...
    return (
      <React.Fragment >
        ...
        {formTypes === 'class' &&
          <button onClick={() => this.editFun(`${subDirectory}/timetable/edit/class`, tableData)} style={{ marginTop: "25px", marginLeft: "399px" }} type="submit" className="btn btn-primary btn-sm">Edit</button>
        }
      </React.Fragment>)
  }
}
