    ...
    return (
      <div>
        <Container fluid>
          <br />
          <Row>
            <h6>Time Table - ReSchedule</h6><br />
          ...
          <Row>
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaTable />} text="Staff Wise" to={`${subDirectory}/main/staff_timetable`} />
            </Col>
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaListAlt />} text="Class Wise" to={`${subDirectory}/main/student_timetable`} />
            </Col>
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaTasks />} text="Free Staff" to={`${subDirectory}/main/freestaff_timetable`} />
            </Col>
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaTasks />} text="Reschedule" active  to={`${subDirectory}/main/reschedule`} />
            </Col>
          </Row>
              ...
              <Col sm="6">
                ...
                <Row>
                  ...
                  <Col sm="5">
                    ...
                    <p>9:50 AM - 10:00 AM (10 Min)</p>

                    <p>12:00 PM to 1:00 PM (1 Hour)</p>

                    <p>2:50 PM - 3:00 PM (10 Min)</p>
                  </Col>
                  <Col sm="1"></Col>
                </Row>
