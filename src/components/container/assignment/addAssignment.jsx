  ...
  render() {
    return (
      <Container fluid><br />
        ...
        <Row><h6>Add Assignment</h6></Row>

        <Row>
          <Col sm="3">
            <TabItem icon={<FAIcons.FaBook />} text={"Add Assignment"} active to={`${subDirectory}/main/addAssignment`} />
          </Col>
          <Col sm="3">
          ...
          <Col sm="3">
            <TabItem icon={<FAIcons.FaHireAHelper />} text={"View HomeWork"} to={`${subDirectory}/main/viewHomeWork`} />
          </Col>
        </Row>
        ...
        <CustomCard>
          <div>
            ...
            <Row>
              <Col sm="4">
                {this.renderSelect("Topics", "Topics", this.state.topics)}
              </Col>
            </Row>

            <Row>
              <BootstrapTable data={this.state.studentList} striped hover bordered condensed options={this.options} pagination version='4' search={true} exportCSV={false} scrollTop={'Bottom'} keyField="name" >
                <TableHeaderColumn dataField='name' dataAlign="center" editable={false} >Name</TableHeaderColumn>
                <TableHeaderColumn dataField='mark' dataAlign="center" >Mark </TableHeaderColumn>
                <TableHeaderColumn dataField='Remarks' dataAlign="center" >Remarks</TableHeaderColumn>
              </BootstrapTable>
            </Row>
