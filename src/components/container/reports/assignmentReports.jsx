...
export default class AssignmentReports extends Component {
      ...
      <div>
        <Container fluid>
          ...
          <Row>
            ...
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaBook />} text="Assignment" to={`${subDirectory}/main/assignment_reports`} active={true} />
            </Col>
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaFileInvoiceDollar />} text="Fee Details" to={`${subDirectory}/main/fee_reports`} />
            </Col>
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaTasks />} text="Events" to={`${subDirectory}/main/event_reports`} />
            </Col>
          </Row>
          <br />
          ...
          <CustomCard>
            ...
            <Row >
              <BootstrapTable data={products} striped hover bordered condensed options={this.options} pagination version='4' search={true} exportCSV={false} scrollTop={'Bottom'} >
                ...
                <TableHeaderColumn dataField='totalmarks' dataSort >Total Marks </TableHeaderColumn>
                <TableHeaderColumn dataField='marksobt' dataSort >Marks Obatained </TableHeaderColumn>
