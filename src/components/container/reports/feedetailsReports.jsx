...
export default class FeeDetailsReports extends Component {
      ...
      <div>
        <Container fluid>
          ...
          <Row>
            ...
            <Col sm="2">
              <TabsItem icon={<FAIcons.FaFileInvoiceDollar />} active={true}  text="Fee Details" to={`${subDirectory}/main/fee_reports`} />
            </Col>
            <Col sm="2">
          ...
          <CustomCard>
            ...
            <Row >
              <BootstrapTable data={products} striped hover bordered condensed options={this.options} pagination version='4' search={true} exportCSV={false} scrollTop={'Bottom'} >
                ...
                <TableHeaderColumn dataField='exception' dataSort >Exception</TableHeaderColumn>

                <TableHeaderColumn dataField='paiddate' dataSort >Paid Date</TableHeaderColumn>
              </BootstrapTable>
            </Row>
