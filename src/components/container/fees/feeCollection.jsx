  ...
  render() {
    return (
      <Container fluid><br />
        ...
        <Row><h6>Fee Collection</h6></Row>

        <Row>
          <Col sm="3">
            <TabsItem icon={<FAIcons.FaHourglassHalf />} text="Fee Allocation" to={`${subDirectory}/main/fee_allocation`} />
          </Col>
          <Col sm="3">
            <TabsItem icon={<FAIcons.FaUserClock />} text="Fee Collection"  active={true}  to={`${subDirectory}/main/fee_collection`} />
          </Col>
        </Row>
