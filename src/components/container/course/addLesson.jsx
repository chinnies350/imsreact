    ...
    return (
      <Container fluid><br />
        ...
        <Row>
          ...
          <Col sm="2">
            <TabsItem icon={<FAIcons.FaClipboardList />} text="Subject" to={`${subDirectory}/main/add_subject`} />
          </Col>
          <Col sm="2">
            <TabsItem icon={<FAIcons.FaBookReader />} text="Lesson" active={true}  to={`${subDirectory}/main/add_lesson`} />
          </Col>
        </Row>
        ...
        <CustomCard>
          <div>
            ...
            <Row> 
              <Col sm="12">
                {this.renderTextArea("Lesson Name", "Lesson Name")}
              </Col>
            </Row>  
