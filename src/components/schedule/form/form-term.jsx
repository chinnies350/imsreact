...
import DateRangePicker from 'components/common/forms/date-range-picker';
...
export default class TermForm extends Component {
  ...
  async componentDidMount() {
    ...
    console.log(";;;;;;;;;;;; the data at shecdule ", data)
              ...
              <section>
                ...
                <Row>
                  ...
                  <Col sm={12} md={5}>
                    ...
                    {/* <DateRangePicker
                      onChange={(data) => this.dateValue(data, "date")} validate={e => this.validateProperty('date', e)} isOutsideRange={isOutsideRange} field="date" label="Date" id="date" startDate={moment(formState.values.startDate)} endDate={moment(formState.values.endDate)}
                      minDate={new Date()}
                    /> */}
                  </Col>
                </Row>
