...
export default class Result extends Component {
    ...
    getResultList = async (params, userType, uid, studentId) => {
        console.log(' online exam result')
    ...
    render() {
        ...
        const { isPageLoading, isLoading, data,client, clientIds, entityIds, branchIds, departmentIds, batchIds, examname, type, isClient, isEntity, isBranch, isDepartment, isBatch } = this.state;
                    ...
                    <Fragment>
                        <Container fluid>
                            <Breadcrumb>
                                ...
                                <BreadcrumbItem><NavLink to={`${subDirectory}/exam/onlineExam`}>Online-Exam</NavLink></BreadcrumbItem>
