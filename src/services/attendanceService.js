...
export function staffAttendanceAdd(data) {
    return http.post(`${apiUrl}/staffattendance`, data);
}
export function staffEditAttendance(data) {
    return http.put(`${apiUrl}/staffattendance`, data);
}
...
export function getStaffAttendancelist(url) {
    return http.get(`${apiUrl}/staffattendance?${url}`);
}
...
export function getStaffAllreports(url) {
    return http.get(`${apiUrl}/staff_attendance?${url}`);
}
